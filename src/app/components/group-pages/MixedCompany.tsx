  ...
  return (
    <>
      <p>
        ...
        founded in 1985. Widely recognized both on campus and around the
        country, Mixed Co produces a wide variety of music from all genres,
        singing pop, R&B, indie hits, classics, and more. Every year, they put
