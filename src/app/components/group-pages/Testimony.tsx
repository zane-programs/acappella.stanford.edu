  ...
  return (
    <>
      <Text>
        ...
        award-winning Christian a cappella group. Now celebrating thirty-six
        ...
        internationally. Through year round concerts ranging from performances
        on campus, to local church services, to homeless shelters and soup
