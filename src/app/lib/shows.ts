/**
 * Shows data from the Google Sheet behind the Shows page.
 *
 * Extracted verbatim from `app/shows/page.tsx` so the homepage preview and the
 * Shows page share one fetcher. The sheet is read per request (the pages that
 * use this are `force-dynamic`).
 */
